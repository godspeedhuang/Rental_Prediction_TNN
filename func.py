...
def get_data(villname):
    with open('web_map/vill.geojson',mode='r',encoding='utf-8') as file:
        data=json.load(file)
...
def make_map(villname):
    ...
    map.save(r'web_map\map_test.html')
    return html.Div(
        className='map-container',
        children=[
            html.Iframe(srcDoc=open(r'web_map\map_test.html','r',encoding='utf-8').read(),width='100%',height=750),
        ]
    )
